...
this.configSearchSectionName = "Settings:AdvWMap:Search"
...
this.searchNearbyFieldId = "searchNearby"
this.searchModeFieldId = "searchMode"
this.disabledDoorsFieldId = "disabledDoors"
this.disabledActorsFieldId = "disabledActors"
